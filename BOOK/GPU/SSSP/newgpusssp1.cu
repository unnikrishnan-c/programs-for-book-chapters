...
if(cudaMemcpy(&(temp1.updated[2]),&(falcvt1),sizeof(bool),cudaMemcpyHostToDevice)!=cudaSuccess)printf("memcpyerror 1");
...
if(cudaMemcpy(&(temp2.dist[2]),&(falcvt2),sizeof(int ),cudaMemcpyHostToDevice)!=cudaSuccess)printf("memcpyerror 2");
